...
// ---------- SESSION / AUTH ----------
// Same OTP-based login experience as MatricAce (per your instruction to
// keep the auth EXPERIENCE, not necessarily the exact backend), but
// wired to Supabase Auth properly so every subsequent request carries
// a real user JWT instead of the anon key.

const AfriAceAuth = {
  /** Step 1: request an OTP be emailed/texted to the given identifier. */
  ...
  /** Step 2: verify the OTP the user received, completing sign-in. */
